...
int main(int argc, char const *argv[])
{
    ...
    sf::ConvexShape background(4);
    utl::build_rectangle(background, sf::Vector2f(width / 2, height / 2), width + 10, height + 10); // Margin
    ...
    float default_player_spd{200.0f};
    float default_ball_spd{10.0f};
